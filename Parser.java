...
public class Parser  {
    ...
    /**
     * Renvoie une commande à partir du texte tapé
     * @param pInputLine Ligne tapée dans la zone de texte
     * @return Une commande
     */
    public Command getCommand( final String pInputLine ) {
        ...
        //CommandWords == this.aCommandWords
        if ( CommandWords.isCommand( vWord1 ) )
    ...
    /**
     * Renvoie une String des commandes utilisables
     * @return une String des commandes utilisables
     */
